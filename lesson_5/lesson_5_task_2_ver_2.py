# Реализовать сложение и умножение двух шестнадцатеричных чисел.
# Не использовать функции прямого перевода из hex в int.
# Использовать сложение и умножение в столбик.
